...
class Product(Base, AuditMixin):
    ...
    categories = relationship("Category", back_populates="product", cascade="all, delete-orphan")
    countries = relationship("Country", back_populates="product", cascade="all, delete-orphan")


class Nutrient(Base, AuditMixin):
    __tablename__ = 'nutrients'
    
    barcode = Column(String, ForeignKey('products.barcode'), primary_key=True)
